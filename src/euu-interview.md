...
title: "Interview with Euu - The Insitorian"
heading: "Interview with Euu"
subtitle: "Challenger · Candidate for Promitor, Avalon & Boucher"
interviewer: "untech"
translated: true
rootPath: "../../"
...
{% zh %}
朋友介绍了解到这个游戏的。经济玩法让我感觉很有趣，和朋友一起玩有很多趣事。
{% endzh %}

**What are your current long-term goals in-game?**

My current long-term goal is to grow and expand the Chinese
community and to transform the organization I lead into a large
economic entity.

{% zh %}
现在的长期目标就是发展壮大中文社区，将我所领导的组织打造成一个大型经济体。
{% endzh %}
...
involve artificial intelligence, the food and beverage industry,
and agricultural production.

{% zh %}
我在现实生活中拥有多家企业，设立在多国。英国，美国，香港，中国内地。从事人工智能以及餐饮行业，以及农业生产。
{% endzh %}
...
I was dissatisfied with the fact that government funds were
...
Previously, I favored Insitor, since it is the region I started
in, and promoted it in my tutorials. However, after the events
surrounding the elections, I am dissatisfied with COSM, which is
the dominant force in the Insitor region. So I don't confine
myself to Insitor anymore.
...
I'm generally not interested in positions of power, but I will
strongly advocate against something I believe is unreasonable,
and this applies to me in real life as well.

{% zh %}
对于权力职位我通常不感兴趣，当我认为这项事情
不合理时我会极力促成，即在现实生活我也是如此。
{% endzh %}
...
The remaining 23% will be used to maintain the existing
infrastructure on the planets.
...
construction. This will promote overall development. The current
situation is a mess.
...
without registering. Some might think that this is not very
transparent. What do you think about this? Would you allow
browsing the website without registration in future?**

You don't need to provide any personal information to register
on the bank website. You only need to enter your in-game
nickname so that I can contact you. If someone can't even manage
to sign up, I don't think the issue is my lack of transparency
but rather their bias.

{% zh %}
银行网站的注册不需要你的任何信息，仅需要你
使用你的董事名称作为账户让我可以找到你。
如果连注册都做不到，我想并不是因为我不进行
公开，而是这部分人拥有偏见。
{% endzh %}

## Politics

**You seem to be running alone. Are you planning to introduce
...
I've already announced my allies publicly but the information
might have been lost due to the volume of messages.
...
想法以及更好的活力。我相信这也是游戏的一些
趣味。
{% endzh %}

**One notable aspect of this election is that the group who
support you seems to be exclusively Chinese-speaking. Is this
election a power struggle between Chinese- and English-speaking
factions?**

Currently, most of my supporters are from the Chinese community.
There are also some English-speaking players who support me, but
not many. That's okay. My plan would benefit everyone. Unlike
COSM, which changed its stance just before the election, I will
fulfill my obligations to my supporters and won't back down from
my platform.
